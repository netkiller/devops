...
module = '/Users/neo/GitHub/devops'
...
dockerfile.image("openresty/openresty:alpine").run("apk add -U tzdata")
...
openresty.volumes(["/var/log/openresty:/usr/local/openresty/nginx/logs", "/opt/grey.conf:/etc/nginx/conf.d/default.conf", "/opt/nginx-conf/location/weixin_business_host.location:/etc/nginx/weixin_business_host.location", "/opt/nginx-conf/certs/ejiayou.com:/etc/nginx/cert", "/opt/nginx-conf/lua:/usr/local/openresty/nginx/lua"])
